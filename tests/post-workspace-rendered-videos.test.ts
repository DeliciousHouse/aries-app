...
test('RenderedVideosSection renders one video card per rendered video artifact', async () => {
  ...
  await act(async () => {
    root = create(
      React.createElement(RenderedVideosSection, {
        artifacts: [
          {
            id: 'video_youtube_offer_clarity',
            type: 'video',
            stage: 'production',
            title: 'YouTube offer clarity',
            category: 'creative',
            status: 'ready',
            summary: 'Rendered creative',
            details: [],
            contentType: 'video/mp4',
            url: 'https://cdn.example.com/youtube-offer-clarity.mp4',
            posterUrl: 'https://cdn.example.com/youtube-offer-clarity.jpg',
  ...
  assert.deepEqual(
    ...
    [
      {
        src: 'https://cdn.example.com/youtube-offer-clarity.mp4',
        poster: 'https://cdn.example.com/youtube-offer-clarity.jpg',
      },
      {
