...
| `tests/insights-endpoints.test.ts` | all five Insights endpoints (Sections 2–6) against live schema + seed data; wires `aries_post_id` via a temp post insert, rolled back after | seed: `npm run db:seed-insights` |
