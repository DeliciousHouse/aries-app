...
test('bridge(b): accepts artifacts.images[].filePath shape — index→assetId, filePath→path, status:generated→completed', () => {
  withAppBaseUrl(() => {
        ...
        images: [
          {
            index: 0,
            status: 'generated',
            filePath: '/home/node/.hermes/cache/images/image_render_20260513_aaa111.png',
          ...
          },
          {
            index: 1,
            status: 'generated',
            filePath: '/home/node/.hermes/cache/images/image_render_20260513_bbb222.png',
    ...
    assert.ok(
      first.artifact_url.includes('image_render_20260513_aaa111.png'),
    ...
    assert.ok(second.artifact_url.includes('image_render_20260513_bbb222.png'));
  });
});
