      ...
      await t.test(scenario.name, async () => {
        ...
        await pool.query(
          `INSERT INTO scheduled_posts (
             id, post_id, tenant_id, scheduled_for, target_platforms, campaign_end_date,
             dispatch_status, dispatch_claimed_at, dispatch_started_at, dispatch_attempt_token
           ) VALUES (
             71, 42, 15, '2020-01-01T00:00:00Z', ARRAY['facebook']::text[], $1,
             $2, '2020-01-01T00:00:00Z', $3, '00000000-0000-4000-8000-000000000071'
           )`,
