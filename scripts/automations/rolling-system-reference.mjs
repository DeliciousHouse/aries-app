...
const knownIssues = [
  ...
  'Hermes is the sole execution provider; the legacy execution path has been removed.',
]
...
const markdown = [
  ...
  '- `backend/execution/*` owns the general execution provider boundary; Hermes is the only provider.',
