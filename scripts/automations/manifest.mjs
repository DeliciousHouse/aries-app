...
export const automationJobs = [
  ...
  },
  {
    ...
    tz: 'America/Los_Angeles',
    message:
      `Work in ${repoRoot}. Run node scripts/automations/feedback-daily-summary.mjs --mark-sent. Return only the emitted summary.`,
  ...
  },
  {
    ...
    tz: 'America/Los_Angeles',
    message:
      `Work in ${repoRoot}. Run node scripts/automations/ci-watcher-dispatch.mjs. For every open GitHub issue labeled ci-watcher that has no matching ao session, this spawns an ao worker (ao spawn <issue>). Dedup is by issueId so the same issue never double-spawns. Return only the concise dispatcher summary.`,
    purpose:
  ...
  },
  {
    ...
    tz: 'America/Los_Angeles',
    message:
      `Read and follow: ${repoRoot}/skills/aries-runtime-error-intake/SKILL.md\n\nContext:\n- Project: ${repoRoot}\n- Incident log: ${repoRoot}/data/runtime-error-incidents.json\n- Delivery lane: Discord #ai-engineering with Telegram fallback handled by the cron delivery config.`,
  ...
  },
  {
    ...
    tz: 'America/Los_Angeles',
    message:
      `Read and follow: ${repoRoot}/skills/aries-runtime-error-repair-loop/SKILL.md\n\nContext:\n- Project: ${repoRoot}\n- Incident log: ${repoRoot}/data/runtime-error-incidents.json\n- Delivery lane: Discord #ai-engineering with Telegram fallback handled by the cron delivery config.`,
