 ...
 *
 * S6-1 / AA-114 (gaps A6a/F3) — the canonical goal vocabulary the WRITE path
 ...
 * it hits the `brand` / `aware` family and resolves to brand_awareness, but the
 * option's own description is about followers and engagement — content_growth.
 * Stating it here is what fixes it.
 */
 ...
 * back through keyword families is what mislabels it — "Increase social media
 * presence" matches no family and lands on the brand_awareness fallback, even
 * though the option is explicitly about followers and engagement.
 *
...
/**
 * S6-1 / AA-114 — the ONE decision every `business_profiles` write makes about
