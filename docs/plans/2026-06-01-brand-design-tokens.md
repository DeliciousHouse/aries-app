...
| Render (manual, live) | `/dashboard`, `/insights`, `/review`, `/dashboard/settings/channel-integrations`, public `/` with flag ON via `/browse`; before/after screenshots; legibility spot-check (muted text + button label) | manual |
