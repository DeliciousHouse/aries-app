...
export default function AriesBusinessProfileScreen() {
  ...
  // S6-1/AA-114: the canonical goal the operator picks, stored alongside the
  // free text. '' renders as "Not set yet", which is honest — it is what keeps
  // the S1-5 confirm chip asking instead of a guess looking settled.
        ...
        >
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              {/* S6-1/AA-114: the canonical goal is CHOSEN here. It decides which
                  metric Insights reports. The free text below stays as the
                  descriptive wording that feeds the Hermes brand prompts — two
