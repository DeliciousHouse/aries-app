...
description: Generate the Aries daily brief and return only its concise operational summary. Use when asked to run the daily brief manually or from cron.
---
