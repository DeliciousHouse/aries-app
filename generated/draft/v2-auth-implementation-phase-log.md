...
- started_at: 2026-03-09T18:43:35.000Z
...
- V2-1-G02 Credential Handling Guardrails: fail
  - G02-C01: pass (Credential fields are absent from success payload schemas)
  - G02-C02: fail (Config manifest uses non-placeholder secret source values)
...
- V2-1-G04 Canonical Auth Failure Shapes: fail
  - G04-C01: pass (Auth denials use canonical AuthError schema)
  - G04-C02: fail (Error code domain is finite and documented)
