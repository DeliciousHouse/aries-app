            ...
            <AnimatePresence>
              {isAccountMenuOpen ? (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 8, scale: 0.98 }}
                  transition={{ duration: 0.18, ease: 'easeOut' }}
                  className="absolute bottom-0 left-full z-[90] ml-3 w-[280px] overflow-hidden rounded-2xl border border-white/10 bg-neutral-950 shadow-[0_28px_90px_rgba(0,0,0,0.38)] backdrop-blur-xl"
                >
                  <div className="space-y-1 p-2">
                    <Link
